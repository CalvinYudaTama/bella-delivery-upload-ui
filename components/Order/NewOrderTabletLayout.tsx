...
export default function NewOrderTabletLayout({
  ...
  aiRoomsScrollRef, aiRoomsThumbLeft, aiRoomsThumbWidth, updateAiRoomsThumb,
}: NewOrderTabletLayoutProps) {
  return (
    <div
      className="no-page"
    ...
    >
      ...
      <section className="no-section no-section--property">
        ...
        <div className="no-property-card" style={{
          ...
          {/* Row 1: 3 dropdowns */}
          <div className="no-property-card__dropdowns" style={{ display: 'flex', gap: 8 }}>
            <Dropdown
              value={propertyType}
        ...
        {aiPickResult ? (
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'stretch' }}>
              ...
              {/* Right: 3 room images — tablet: hidden native scrollbar + moving thumb slider */}
              <div className="no-ai-pick-result__rooms-wrap" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 15 }}>
                {/* Clip outer — hides native scrollbar */}
                <div style={{ overflow: 'hidden' }}>
                  <div
                    ref={aiRoomsScrollRef}
                    onScroll={updateAiRoomsThumb}
                  ...
                  >
                    {aiPickResult.rooms.map((room, i) => (
                      <div key={i} style={{ width: 250, height: 150, flexShrink: 0, borderRadius: 12, position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ height: 8, background: '#D6D8D9', borderRadius: 6, width: '100%', position: 'relative', overflow: 'hidden' }}>
                  <div style={{ position: 'absolute', top: 0, left: aiRoomsThumbLeft, height: '100%', width: aiRoomsThumbWidth, background: '#858A8E', borderRadius: 6, transition: 'left 0.08s linear' }} />
                </div>
              </div>
            </div>
          </div>
          ...
          /* Brand grid — Tablet: 3 per row, 220×150 cards, wrapped in bg card */
          <div className="no-brand-grid no-brand-grid--tablet" style={{
            background: '#FAFAFA', borderRadius: 12, padding: 0,
            display: 'flex', flexDirection: 'column', gap: 24,
            boxSizing: 'border-box',
          }}>
